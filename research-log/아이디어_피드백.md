...
| Q                | PD              | ND              |
|------------------|-----------------|-----------------|
| upper bound      | rand            | 3GT(rand)       |
| positive quality | q-d term distribution top K% | bottom-3 |
|                  | 1GT(rand)       | top-1           |
| negative quality | q-d term distribution bottom K% | bottom-3 |
|                  | top-1           | 3GT(rand)       |
| lower bound      | rand            | rand            |
